public class Main {
    ...
    public static void task67 () {
        ...
        var weightDifference3 = secondBoxerWeight % firstBoxerWeight;
        System.out.println(weightDifference3);
    }
    public static void task8 () {
        System.out.println("Задача 8");
        var totalWorkTime = 640;
        var totalNumberEmployees = totalWorkTime / 8;
        System.out.println("Всего работников в компании - " + totalNumberEmployees + " человек");
        var newTotalNumberEmployees = totalNumberEmployees + 94;
        var newTotalWorkTime = newTotalNumberEmployees * 8;
        System.out.println("Если в компании работает " + newTotalNumberEmployees + " человек, то всего " + newTotalWorkTime + " часов работы может быть поделено между сотрудниками");
